...
export default function Purchases() {
    ...
    const invoiceStart = async (vendor) => {
        try {
            const response = await fetch(`/invoice/start/${vendor}`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(
                    `/products/show/${invoiceId.invoice_id}`
                );
    ...
    useEffect(() => {
        ...
        const fetchTotal = async () => {
            try {
                const response = await fetch(
                    `/purchase/total/${invoiceId.invoice_id}`
                );
    ...
    const confirmPurchase = async () => {
        ...
        try {
            const response = await fetch(`/purchase/advance/${invoiceId.invoice_id}`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    useEffect(() => {
        if (invoiceId) {
            const fetchInvoiceLedger = async () => {
                const response = await fetch(`/invoices/ledger/show/${invoiceId}`);
                if (!response.ok) {
                    console.log('Error retrieving data');
                }
